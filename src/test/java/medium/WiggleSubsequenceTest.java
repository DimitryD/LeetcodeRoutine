...
class WiggleSubsequenceTest {
    ...
    void test1() {
        ...
        assertEquals(6, wiggleSubsequence.wiggleMaxLength(nums));
    }

    @Test
    void test2() {
        int[] nums = new int[]{1,17,5,10,13,15,10,5,16,8};
        assertEquals(7, wiggleSubsequence.wiggleMaxLength(nums));
    }

    @Test
    void test3() {
        int[] nums = new int[]{1,2,3,4,5,6,7,8,9};
        assertEquals(2, wiggleSubsequence.wiggleMaxLength(nums));
    }
    ...
    void test5() {
        int[] nums = new int[]{1};
        assertEquals(1, wiggleSubsequence.wiggleMaxLength(nums));
    }
